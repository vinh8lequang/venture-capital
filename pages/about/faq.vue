       ...
       <div class="d-flex justify-center">
            <v-card width="50%" class="pa-5">
                <v-card-title class="text-h6 text-sm-h6 text-sm-h6"
                    >Below you can find the answers to some of the most common questions we get asked.</v-card-title>
                <v-divider
                    :thickness="3"
                ...
                <p>Yes, we are excited to meet talented founders everywhere in the world.</p>
                <v-card-title  class="text-caption text-md-h5 font-weight-light">How do I seek investment from HEP?</v-card-title>
                <p>You should first apply to Horizon Equity Partners. The best way for us to get to know you is to evaluate you as a member of our community. You will have a better chance of being noticed when you’re raising money if you are already a member of HEP.</p>
                <p>Our process of evaluating companies for investment begins with the same conversation we would have with you as a prospective member of Hardware Club. We may have multiple conversations with you and introduce you to different people at HEP. If these conversations go well, we will schedule a partner meeting, where all our partners get to know you better.</p>
                <p>In the partner meeting, we will ask you to put together a short deck to present for 15-20 minutes followed by 25-30 minutes of questions. We like to keep these meetings focused on short, data-driven discussion.</p>
                <p>We debrief during our regular team meetings. Because we are thorough, sometimes it can take us a few weeks to make a decision. Please be patient.</p>
            </v-card>
        </div>
    </div>
</template>
